...
echo "password=${password,,}" >> ${HOME}/ArchTitus/configs/setup.conf
    ...
    echo "NAME_OF_MACHINE=${name_of_machine,,}" >> ${HOME}/LecArch/configs/setup.conf
fi
echo -ne "
-------------------------------------------------------------------------
                    Adding User
...
# use chpasswd to enter $USERNAME:$password
	...
	cp -R $HOME/LecArch /home/$USERNAME/
    chown -R $USERNAME: /home/$USERNAME/LecArch
    echo "LecArch copied to home directory"
